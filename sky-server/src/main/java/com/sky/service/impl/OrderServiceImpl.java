...
public class OrderServiceImpl implements OrderService {
    ...
    public PageResult pageQuery(Integer page, Integer pageSize, Integer status) {
        ...
        OrdersPageQueryDTO ordersPageQueryDTO = OrdersPageQueryDTO
                .builder()
                .userId(userId)
                .status(status)
                .build();
    ...
    public void rejection(OrdersRejectionDTO ordersRejectionDTO) throws Exception {
        ...
        // 3. 获取支付状态
        getPayStatusAndRefund(ordersDB);
     ...
     * @param ordersDB
     */
    private void getPayStatusAndRefund(Orders ordersDB) throws Exception {
